package com.example.intellitasks // Asegúrate de que el paquete sea el correcto
        ...
        auth.signInWithEmailAndPassword(email, password)
            .addOnCompleteListener { task ->
                ...
                if (task.isSuccessful) {
                    ...
                    _loginResult.value = true // Publicar éxito
                } else {
                    ...
                    _loginResult.value = false // Publicar fallo
